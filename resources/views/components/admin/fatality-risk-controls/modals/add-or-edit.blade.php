<x-modal id="addFatalityRiskControlModal" title="Create a new fatality risk control" :staticBackdrop="true"
         size="modal-lg"
         :scrollable="true">
    <x-form action="{{ route('fatality-risk-controls.store') }}" :hasFile="true" id="addFatalityRiskControlForm">
        ...
        <div class="mb-2">
            ...
            <x-form.text-area name="description"
                              placeholder="Write a short description about the fatality risk control..."
                              :useCkeditor="true"/>
