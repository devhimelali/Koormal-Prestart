        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('actions', function ($row) {
                    ...
                    $btns .= '<button class="btn btn-sn btn-secondary edit d-flex align-items-center" data-id="' . $row->id . '" >
                                <i class="ph ph-pencil me-1"></i>
                                Edit
                            </button>';
                    $btns .= '<button class="btn btn-sn btn-danger delete d-flex align-items-center" data-id="' . $row->id . '" >
